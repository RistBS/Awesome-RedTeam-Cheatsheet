...
- [AD Exploitation Cheat Sheet by RistBS](#active-directory-exploitation-cheat-sheet)
  ...
  - [Microsoft Protocols and Services Abusing](#microsoft-protocols-and-services-abusing)
    - [Kerberos](#kerberos)
      - [PassTheHash](#passthehash)
      - [OverpassThehash](#overpassthehash)
      - [PassTheTicket](#passtheticket)
      - [Tickets Forging](#tickets-forging)
    - [Coerced Auth](#coerced-auth)
  ...
  - [Credentials Dumping](#credentials-dumping)
    ...
    - [Read LAPS Passwords](#read-laps-password)
